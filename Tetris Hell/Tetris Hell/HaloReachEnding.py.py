...
def main():
    ...
    showTextScreen('Perish')
    while True: # game loop
        if random.randint(0, 1) == 0:
            pygame.mixer.music.load('pizzatime.mp3')
        else:
            pygame.mixer.music.load('newtetristheme.mp3')
...
def showTextScreen(text):
    ...
    pressKeySurf, pressKeyRect = makeTextObjs('Please dont play (Press A).', BASICFONT, TEXTCOLOR)
